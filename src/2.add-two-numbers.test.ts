...
Deno.test({
  ...
  fn() : void {
    ...
    const expected = new ListNode(8, new ListNode(9, new ListNode(9, new ListNode(1, null))))
    assertEquals(addTwoNumbers(l1, l2), expected);
  }
})
...
Deno.test({
  ...
  fn() : void {
    ...
    const expected = new ListNode(8, new ListNode(9, new ListNode(0, new ListNode(1, null))))
    assertEquals(addTwoNumbers(l1, l2), expected);
  }
})